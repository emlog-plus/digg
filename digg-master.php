...
?>
<?php
	$digg_dir = EMLOG_ROOT . '/content/plugins/digg-master/';
...
<?php function digg_digg ( $blogid ) { ?>
	...
	<ul class="z_digg">
		<li class="digg"><button class="example zakura"><img src="<?php echo BLOG_URL.'content/plugins/digg-master/common/digg.png'; ?>" /><span>赞</span><span class="value"><?php echo $digg_value[0]; ?></span></button></li>
		<li><?php 	global $CACHE;
...
<?php endif;?></li>
		<li class="undigg"><button class="example zakura"><img src="<?php echo BLOG_URL.'content/plugins/digg-master/common/undigg.png'; ?>" /><span>踩</span><span class="value"><?php echo $digg_value[1]; ?></span></button></li>
	</ul>
<?php }
...
<?php function digg_css() {
	$font = BLOG_URL.'content/plugins/digg-master/';
	$animate = BLOG_URL.'content/plugins/digg-master/common/animate.css';
...
<?php function digg_script_init ( ) {
	$jquery =BLOG_URL.'content/plugins/digg-master/common/jquery.min.js';
	echo "<script type='text/javascript'>
